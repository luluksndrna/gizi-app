...
$pasiendm=tampil("SELECT * FROM pasiendm");

if (isset($_POST["cari"])) {
	$pasiendm=cari($_POST["keyword"]);
}
...
<head>
    ...
    <title>Data Laporan Asupan Makan Pasien DM</title>
...
<body>
	...
	<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                	<h1>Data Laporan Asupan Makan Pasien DM</h1>
                	<br>
