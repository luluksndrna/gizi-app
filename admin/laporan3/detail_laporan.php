...
$data=mysqli_query($conn,"SELECT DISTINCT tanggal,id_pasien FROM pasiendm WHERE id_pasien= '$id_pasien' ");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <?php 
                              foreach ($data as $d) { ?>
                                <a href="../detail3/?id_pasien=<?= $d['id_pasien'] ?>&tanggal=<?= $d["tanggal"];  ?>"><?php echo $d["tanggal"];  ?></a><br>
                             <?php  } ?>
                        </div>
                    </div>
                </div>
