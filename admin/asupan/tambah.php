                                ...
                                <div class="col-lg-12">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kalori" id="exampleFormControlSelect1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" type="text" name="karbohidrat" id="karbohidrat" required>
                                                  <option>-</option>
                                                  <option>60%</option>
                                                  <option>61%</option>
                                                  <option>62%</option> 
                                        ...
                                        <div class="form-group">
                                            <label for="fa">Faktor Aktivitas</label>
                                            <select class="form-control" name="fa" id="fa" required>
                                              <option>-</option>
                                              <option>1.2</option>
                                              <option>1.3</option>
                                              <option>1.4</option> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="fs" id="fs" required>
                                              <option>-</option>
                                              <option>1</option>
                                              <option>1.2</option>
                                              <option>1.35</option> 
