						...
						<div class="panel-body">
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tr>
									...
									<td>
										<a href="edit.php?id_kamar=<?php echo $g["id_kamar"]; ?>">edit</a> | 
										<a href="hapus.php?id_kamar=<?php echo $g["id_kamar"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus ini')">hapus</a>
									</td>
								</tr>
								<?php } ?>
								</tbody>
