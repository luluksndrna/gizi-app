...
<head>
    ...
    <title>Data Laporan Pasien DM</title>
                                ...
                                <div class="col-lg-12">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="kalori" id="kalori">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="karbo" id="karbo">
                                        </div>
                                        <div class="form-group">
                                            <label for="lemak">Lemak</label>
                                            <input class="form-control" type="text" name="lemak" id="lemak">
                                        </div>
