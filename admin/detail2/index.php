...
$laporan_pagi	=mysqli_query($conn,"SELECT * FROM asupan WHERE id_pasien='$id_pasien' AND tanggal='$tanggal' AND waktu='Pagi'");
$laporan_siang	=mysqli_query($conn,"SELECT * FROM asupan WHERE id_pasien='$id_pasien' AND tanggal='$tanggal' AND waktu='Siang'");
$laporan_malam	=mysqli_query($conn,"SELECT * FROM asupan WHERE id_pasien='$id_pasien' AND tanggal='$tanggal' AND waktu='Malam'");
                    ...
                    <div class="panel">
						...
						<div class="panel-body">
							<table width="100%" class="table table-striped table-bordered">
                                ...
                                <td>: <?php
                                        $lemak=$data_pagi2['lemak']/$data_pagi['lemak']*'100';
                                  echo ''.$lemak.'%'; ?></td>
                                    </tr>
                                ...
                                <td>: <?= $data_siang['kalori'] ?></td>
                                 <td>: <?php
                                        $kalori=$data_siang2['kalori']/$data_siang['kalori'];
                                  echo ''.$kalori.'%'; ?></td>
                                ...
                                <td>: <?php
                                        $protein_gr=$data_malam2['protein']/$data_malam['protein_gr']*'100';
                                  echo ''.$protein_gr.'%'; ?></td>
                                ...
                                <td>: <?= $data_malam['karbo_gr'] ?></td>
                                 <td>: <?php
                                        $karbo_gr=$data_malam2['karbo']/$data_malam['karbo_gr']*'100';
                                  echo ''.$karbo_gr.'%'; ?></td>
                                ...
                                <td>: <?php
                                        $lemak_gr=$data_malam2['lemak']/$data_malam['lemak_gr']*'100';
                                  echo ''.$lemak_gr.'%'; ?></td>
                                    </tr>
