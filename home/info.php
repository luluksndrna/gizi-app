...
<body id="page-top">
  ...
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Informasi Gizi</h2>
      ...
      <!-- Contact Section Form -->
        ...
        <div class="intro-text left-5 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">Pelayanan Gizi Rumah Sakit</span>
          
          </h2>
          <p class="mb-3">Pelayanan gizi rumah sakit adalah pelayanan gizi yang disesuaikan dengan keadaan pasien dan berdasarkan keadaan klinis, status gizi, dan status metabolisme tubuhnya. Keadaan gizi pasien sangat berpengaruh pada proses penyembuhan penyakit, sebaliknya proses perjalanan penyakit dapat berpengaruh terhadap keadaan gizi pasien
